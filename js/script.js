function drawHeatmap() {
    ...
    'Oz Park Loop.gpx',
    'Illinois and Michigan Canal Trail_ Joilet to Lockport.gpx',
    'Rosenblum (J. Leslie) Park Loop.gpx',
    'Illinois Prairie Path via 1st Avenue.gpx',
    'Major Taylor Trail to Whistler Woods.gpx',
    'I & M Canal Trail.gpx',
    'Mozart (Amadeus) Park Walk.gpx',
    'La Villita Park Walk.gpx',
    'Dan Ryan Black Paved Loop Trail.gpx',
    'Vollmer Grove Trail.gpx',
    ...
    gpxFileNames.forEach(gpx => {
        ...
        .addTo(map)
        .bindTooltip(gpx.replace('.gpx',''), {sticky: true, className: 'tooltipClass'});
    });
